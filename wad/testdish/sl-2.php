        ...
        <div class="container">
            ...
            <div class="foods">
                <div class="single-food">
                    ...
                    <ul class="food-list">
                        <li>yellow split peas <span>200 g</span></li>
                        <li>onion, chopped <span>1 </span></li>
                        <li>salt flakes<span>70 g</span></li>
                        <li>canned coconut milk <span>½ head </span></li>
                        <li>coconut oil <span>2 tbsp </span></li>
                        <li>ground turmeric<span>1½ tsp</span></li>
                        ...
                        <li>crispy fried shallots<span>1 tsp</span></li>
