        ...
        <div class="container">
            ...
            <div class="foods">
                <div class="single-food">
                    ...
                    <ul class="food-list">
                        <li>Bengal gram<span>100 g</span></li>
                        <li>mustard oil<span>1½ tbsp</span></li>
                        <li>cumin seeds<span>1 tsp</span></li>
                        <li>nigella seeds<span>½ tsp</span></li>
                        <li>thinly sliced white onion<span>1 cm</span></li>
                        <li>green chillies<span>2</span></li>
                        <li>turmeric powder<span>¼ tsp</span></li>
                        <li>Kashmiri red chilli powder<span>2</span></li>
                        <li>ground coriander<span>125 ml</span></li>
                    </ul>
                </div>
                <div class="single-food">
                    <div class="food-img">
